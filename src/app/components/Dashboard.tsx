...
const Dashboard = () => {
  ...
  return (
    <div className="">
      ...
      >
        <p className="opacity-0 group-hover:opacity-100 absolute bottom-[7px] xl:bottom-3 right-3 bg-background text-xl xl:text-2xl text-primary-foreground px-2 py-1 rounded-md transition-all duration-200 font-semibold">
          Invoice
        </p>
